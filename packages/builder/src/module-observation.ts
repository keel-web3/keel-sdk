...
export function detectKeelModuleFormat(source: string): "classic" | "esm" {
  return ts.isExternalModule(ts.createSourceFile("upload.js", source, ts.ScriptTarget.ES2022, true, ts.ScriptKind.JS)) ? "esm" : "classic";
}
