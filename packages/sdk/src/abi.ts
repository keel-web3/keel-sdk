...
export const keelIndexAbi = [
  ...
  "function announceActiveRevision(address collection, uint256 tokenId, bool tokenSpecific)",
  ...
  "event MetadataNotificationFailed(address indexed collection, uint256 indexed tokenId, bool tokenSpecific)",
...
export const keel721Abi = [
  ...
  "function metadataRelay() view returns (address)",
  "function name() view returns (string)",
  "function nextTokenId() view returns (uint256)",
  "function notifyDependencyMetadata(uint256 first,uint256 last)",
  "function notifyIndexRevision(uint256 tokenId,bool tokenSpecific)",
  ...
  "function supportsCompactTokenURI() pure returns (bool)",
  "function supportsInterface(bytes4 interfaceId) view returns (bool)",
  ...
  "event MetadataRelaySet(uint256 indexed scope,address indexed relay)",
