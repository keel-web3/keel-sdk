...
export const keelFeeTreasuryAbi = [
  ...
  "event PayoutWalletConfigured(address indexed wallet,uint64 revision,uint64 unlockAt)",
  "event AccessGroupsConfigured(address indexed groups,uint64 revision)",
  "event CustomPayoutLimitConfigured(address indexed asset,uint256 maximum,uint64 revision)",
  "event GroupPayout(bytes32 indexed groupId,address indexed recipient,address indexed asset,uint256 amount,bool custom)",
  "error FeeTransferFailed()",
