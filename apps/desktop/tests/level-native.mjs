// Builds the editor's main with the keyless level fixture as its assistant
// provider, next to a copy of everything the desktop build made (dist/, so new
// workers and pages come along), for electron-level.cjs. Run it with Node (or
